...
/// </summary>
public delegate Task SentDelegate(MimeMessage message, MailSendResult result);
...
/// </summary>
public delegate Task<bool> MailboxExistsDelegate(ISessionContext context, IMailbox from, IMailbox to);
...
/// </summary>
public delegate Task<SmtpResponse> HandleDelegate(ISessionContext context, MimeMessage message, MailConnectionData authResult);
...
/// </summary>
public delegate Task<(bool SendExternally, string? Log)> BeforeSendDelegate(MailGen mailGen, MailboxAddress currentRecipient, string potentialMessageId);
