...
/// </summary>
public class LegacyRestorePartInfo
{
    /// <summary>
    ...
    /// </summary>
    public readonly LegacyBackupTree OriginIdTree;

    /// <summary>
    /// Creates a new object with information about a part of a backup to restore.
    /// </summary>
    public LegacyRestorePartInfo(string partName, ReadOnlyCollection<string> ids)
    {
        PartName = partName;
    ...
    private static void LoadRecursive(StreamReader reader, LegacyBackupTree tree, string id)
    {
        int read;
    ...
    private bool Restore(string originDirRel, string targetDir, LegacyBackupTree tree)
    {
